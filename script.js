  ...
  grid.innerHTML = issues.map(issue => {
    ...
    return `
      <div class="issue-card bg-white rounded-lg cursor-pointer p-5 flex flex-col justify-between ${statusClass}" onclick="showDetails(${issue.id})">
        ...
        <div class="border-t-2 border-gray-200 pt-3 mt-auto flex justify-between items-center flex-wrap gap-4 text-[10px] text-[#64748B]">
        ...
        <div class="pt-3  flex justify-between items-center flex-wrap gap-4 text-[10px] text-[#64748B]">
          <span class="font-medium">Assignee: ${issue.assignee || 'Unassigned'}</span>
  ...
  try {
    ...
    content.innerHTML = `
        ...
        <div class="bg-[#F8FAFC] p-6 rounded-xl flex justify-between items-start gap-24"> 
            ...
            <div class="text-left">
                <p class="text-[13px] text-[#64748B] text-center">Priority:</p>
